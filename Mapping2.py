...
#%% Latest attempt, 5/31, improved to show zip codes and a color scale
# Load Libraries
#from lxml import etree
import pandas as pd
import numpy as np
...
#%% Almost final version, now using year built for color scale
# Load Libraries
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
...
#%% Scratch to filter df_map by window polygon

b = [window_polygon.intersects(i) for i in df_map.poly]
#df_map2 = df_map[b]
df_map2 = df_map[ [window_polygon.intersects(i) for i in df_map.poly] ]